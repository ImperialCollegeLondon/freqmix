function g = generate_tstat_quadruplet_graph(trips,teststats,tested_trips,band_ids)
...
for k = 1:size(trips,1)    
    ...
    adj(tri(1),tri(4)) = adj(tri(1),tri(4)) + tstat;
    adj(tri(4),tri(1)) = adj(tri(4),tri(1)) + tstat;
    
    adj(tri(2),tri(4)) = adj(tri(2),tri(4)) + tstat;
    adj(tri(4),tri(2)) = adj(tri(4),tri(2)) + tstat;

    adj(tri(3),tri(4)) = adj(tri(3),tri(4)) + tstat;
    adj(tri(4),tri(3)) = adj(tri(4),tri(3)) + tstat;   
end
