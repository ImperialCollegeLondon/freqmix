...
% Comparison of a group with frequency mixing vs a surrogate of itself.
...
dc = freqmix.data.datacollection(signals,'name','synthetic_scan','channel_names',{'Oz'},...
                            'group_id', group_labels, 'signal_ids', signal_ids,...
                            'sample_ids', patient_ids, 'generate_surrogate',true);
...
save('synthetic_surrogate_experiment.mat','exp')

%% load data

load('synthetic_surrogate_experiment.mat')
